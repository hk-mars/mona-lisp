...
Strategical rules(defined constraints or format, but can be changed), is a needed way for design brevity, but it only be used for limitedness points of system.
